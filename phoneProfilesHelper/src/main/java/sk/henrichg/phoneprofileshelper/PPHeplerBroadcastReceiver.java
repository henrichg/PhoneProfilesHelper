    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals (ACTION_SETPROFILEPREFERENCES))
        {
            ...
            if (procedure.equals(SetProfilePreferenceService.PROCEDURE_RADIO_CHANGE))
            {
                ...
                int networkTypeChange = intent.getIntExtra(SetProfilePreferenceService.NETWORK_TYPE_CHANGE, 0);
                ...
                SystemRoutines.logE("SetProfilePreferenceBroadcastReceiver.onReceive","networkTypeChange="+networkTypeChange);
                ...
                serviceIntent.putExtra(SetProfilePreferenceService.NETWORK_TYPE_CHANGE, networkTypeChange);
            }
